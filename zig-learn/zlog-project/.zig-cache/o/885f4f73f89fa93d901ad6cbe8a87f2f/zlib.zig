...
pub extern fn zlog_zlib_compress(dest: [*c]u8, destLen: [*c]usize, source: [*c]const u8, sourceLen: usize) c_int;
pub extern fn zlog_zlib_uncompress(dest: [*c]u8, destLen: [*c]usize, source: [*c]const u8, sourceLen: usize) c_int;
pub extern fn zlog_crc32(crc: c_ulong, buf: [*c]const u8, len: usize) c_ulong;
...
pub const ZLOG_ZLIB_STUB_H = "";
pub const __STDC_VERSION_STDDEF_H__ = @as(c_long, 202311);
pub const NULL = __helpers.cast(?*anyopaque, @as(c_int, 0));
pub const offsetof = @compileError("unable to translate macro: undefined identifier `__builtin_offsetof`"); // C:\Users\101\scoop\apps\zig\0.16.0\lib\compiler\aro\include\stddef.h:18:9
