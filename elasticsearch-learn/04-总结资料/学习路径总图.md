...
| 顺序 | 章节 | 学什么 |
| --- | --- | --- |
| 1 | [5. Mapping](../01-进阶篇/05-Mapping与字段类型详解.md) | dense_vector / sparse_vector |
| 2 | [6. Analyzer](../01-进阶篇/06-分词器深入.md) | IK 中文分词 |
| 3 | [19. 向量检索](../03-专家篇/19-向量检索与混合搜索(Hybrid-Search).md) | HNSW / 量化 / RRF / ELSER |
| 4 | [20. Painless](../03-专家篇/20-Painless脚本与Runtime-Field深入.md) | 自定义打分 / runtime field |
| 5 | [21. 客户端 SDK](../03-专家篇/21-客户端SDK与生产集成.md) | Python / Java 调 embedding API + ES |
| 6 | [22. Schema 演进](../03-专家篇/22-Schema演进与零停机Reindex.md) | 加 dense_vector 不停机 |

### 4.7 "我要做大规模生产(50K 专家级)"

| 顺序 | 章节 | 学什么 |
| --- | --- | --- |
| 1 | [22. Schema 演进](../03-专家篇/22-Schema演进与零停机Reindex.md) | 零停机 mapping 升级 |
| 2 | [23. 容量规划](../03-专家篇/23-容量规划与成本工程.md) | 节点数 / 成本 / 分层 |
| 3 | [24. SRE Runbook](../03-专家篇/24-SRE实战Runbook与故障复盘.md) | RTO/RPO / 灾备 / 复盘 |
| 4 | [16. 监控](../03-专家篇/16-运维监控与故障排查.md) | 监控三支柱 + 告警矩阵 |
...
- [ ] 用 dense_vector + RRF 搭过混合检索
- [ ] 理解 int8 / bbq 量化的代价
- [ ] 写过 stored script + runtime field 并提升为 doc_values
- [ ] 用 Java API Client / Python 客户端做过生产集成,带熔断限流
- [ ] 做过零停机 schema 升级(双写 + 别名切换)
- [ ] 给业务做过容量规划,推算节点数 / 成本 / SLA
- [ ] 写过 Runbook,处理过 7 类常见故障
- [ ] 配过 RTO/RPO + 跨 region 灾备 + 月度演练
- [ ] 复盘过至少 3 个生产故障,产出 Postmortem
- [ ] 解释集群启动 / master 选举
- [ ] 调过 heap、GC、swap
